...
if %errorlevel% == 0 (
	...
	adb shell "echo PRXXX_fw.img > /sys/class/input/input"%~1"/fw_name"
	adb shell "echo 1 > /sys/class/input/input"%~1"/update_fw"
	adb shell cat /sys/class/input/input%~1/config_id | find "72.83.48.54"
)
